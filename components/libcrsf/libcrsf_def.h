...
#define CRSF_RC_CHANNELS_TICKS_TO_RANGE(x) ((float)(x - CRSF_RC_CHANNELS_CENTER) / CRSF_RC_CHANNELS_RANGE * 2.0f)
#define CRSF_RC_CHANNELS_RANGE_TO_TICKS(x) ((float)(x * CRSF_RC_CHANNELS_RANGE) / 2.0f + CRSF_RC_CHANNELS_CENTER)
