...
typedef enum {
    CRSF_COMMAND_STATE_READY,
    CRSF_COMMAND_STATE_START,
    CRSF_COMMAND_STATE_PROGRESS,
    CRSF_COMMAND_STATE_CONFIRMATION_NEEDED,
    CRSF_COMMAND_STATE_CONFIRM,
    CRSF_COMMAND_STATE_CANCEL,
    CRSF_COMMAND_STATE_POLL,
